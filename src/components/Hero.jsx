    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[75vh] mx-auto py-8 bg-black">
      ...
      <div className="col-span-2 px-5 my-auto">
        ...
        <p className="text-white sm:text-lg my-6 lg:text-xl">
          My name is Talib Abbas and I'm a Web Developer with the skills of MERN
          Stack.
        </p>
        <div className="my-8">
          <a
            href="https://drive.google.com/file/d/1TbdIcDHQZQR_rWsid28_mAKv2_I1jD-b/view?usp=sharing"
            target="_blank"
          ...
          <a
            ...
            target="_blank"
            className="font-medium px-6 py-3 w-full rounded-xl border border-gray-400  text-white  hover:bg-white/10 duration-200"
          >
            Contact
          </a>
        </div>
